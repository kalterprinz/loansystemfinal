        ...
        const fetchStats = async () => {
            try {
                const [
                    ...
                    axios.get('http://192.168.43.245:3001/loan/approved/count'), // Fetch approved loans count
                    axios.get('http://192.168.43.245:3001/loan/pending/count'),
                    axios.get('http://192.168.43.245:3001/loan/review/count'), // Fetch review applications count
                    axios.get('http://192.168.43.245:3001/loan/rejected/count'),
                ]);
