...
const Generate = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
        try {
            const { data: approvedLoansRes } = await axios.get('http://192.168.43.245:3001/loans/status/count');
            const { data: ageRes } = await axios.get('http://192.168.43.245:3001/loan/age-distribution');
            const { data: typedata } = await axios.get('http://192.168.43.245:3001/loans/type/graph');
            const { data: totalLoanRes } = await axios.get('http://192.168.43.245:3001/loan/total-loan-amount');
            const { data: repayRes } = await axios.get('http://192.168.43.245:3001/loan/payment-status');
...
const [currentDateTime, setCurrentDateTime] = useState(new Date());
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const { data: paydata } = await axios.get('http://192.168.43.245:3001/loans/payment/graph');
        const { data: typedata } = await axios.get('http://192.168.43.245:3001/loans/type/graph');
